...
&
    \ensuremath{\Conid{A}\mathbin{+}(\Conid{C}\mathbin{+}\Varid{op}\times(\Conid{Expr}\;\Conid{C}\;\Conid{A}))}
...
&
&
     \ensuremath{\Conid{A}\mathbin{+}(\Conid{C}\mathbin{+}\Varid{op}\times(\Conid{Expr}\;\Conid{C}\;\Conid{B}))}

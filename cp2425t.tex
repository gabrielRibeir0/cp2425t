...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gcata}\mathbin{::}[\mskip1.5mu \Conid{Int}\mskip1.5mu]\to ()+((\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]),[\mskip1.5mu \Conid{Int}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{gcata}\mathrel{=}(\Varid{id}+{}\<[18]%
\>[18]{}(\conj{\conj{\Varid{head}}{\Varid{id}}}{\Varid{tail}}\comp \Varid{cons}))\comp \Varid{outList}\comp \Varid{iSort}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fcata}\mathbin{::}()+((\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]),(\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]))\to (\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{fcata}\mathrel{=}\alt{{}\<[21]%
\>[21]{}\conj{\underline{\mathrm{0}}}{\Varid{nil}}}{\Varid{cond}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\Varid{pp1}}{\Varid{pp2}})\;\p2\;\p1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{hindex}\mathrel{=}\Varid{hyloList}\;\Varid{fcata}\;\Varid{gcata}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{nextPrimeFactor}\mathbin{::}\mathbb{Z}\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{nextPrimeFactor}\;\Varid{n}\mathrel{=}\Varid{head}\;[\mskip1.5mu \Varid{x}\mid \Varid{x}\leftarrow \mathrm{2}\mathbin{:}[\mskip1.5mu \mathrm{3},\mathrm{5}\mathinner{\ldotp\ldotp}\Varid{n}\mskip1.5mu],\Varid{mod}\;\Varid{n}\;\Varid{x}\equiv \mathrm{0}\mathrel{\wedge}\Varid{isPrime}\;\Varid{x}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{primes}\mathrel{=}\anaList{(\Varid{id}+\conj{\Varid{nextPrimeFactor}}{\Varid{aap}\;\cdot \div \cdot \;\Varid{nextPrimeFactor}})\comp \Varid{outPrimes}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Segunda parte:
\begin{hscode}\SaveRestoreHook
...
\>[B]{}\Varid{convolve}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{convolve}\;\Varid{hs}\mathrel{=}\Varid{hyloList}\;\Varid{f}\;\Varid{g}\comp \Varid{suffixes}\comp \Varid{flip}\;\Varid{padZeros}\;(\length \;\Varid{hs}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}(\Varid{id}+(\Varid{zipWith}\;(\mathbin{*})\;(\Varid{reverse'}\;\Varid{hs})\times\Varid{id}))\comp \Varid{outList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpr}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recExpr}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\emph{Ana + cata + hylo}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataExpr}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaExpr}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloExpr}\;\Varid{h}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\emph{Maps}:
\emph{Monad}:
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{let\char95 exp}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mcataExpr}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{evaluate}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
